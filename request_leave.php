                    ...
                    <div class="grid paddin10 no-padding-top  shadow bg-white">
                        <div class="row">
                            <div class="cell padding10">
                               <form class="bg-grayLighter padding5" method="POST" style="width: 70%; margin: 0px auto;">
                                                        ...
                                                        <div class="row no-margin cells2">
                                                            ...
                                                            <div class="cell">
                                                                ...
                                                                <div class="  input-control full-size text">
                                                                    <input readonly="" value="<?php echo $_SESSION['curr_staff_no']?>" type="text" id="id_staff_no" name="staff_no"/>
                                                                </div>
                                                            </div>
                                                             <div class="cell">
...
if(isset($_POST['leave_type']) && isset($_POST['start_date']) && isset ($_POST['end_date'])){
    $staff_no = $_SESSION['curr_staff_no'];
